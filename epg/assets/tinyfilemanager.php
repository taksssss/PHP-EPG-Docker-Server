...
//使用登录名/密码进行身份验证
//设置 true/false 以启用/禁用它
//独立于 IP 白名单和黑名单
$use_auth = false;

//登录用户名和密码
//用户：array('Username' => 'Password', 'Username2' => 'Password2', ...)
//生成安全密码哈希 -https://tinyfilemanager.github.io/docs/pwd.html
$auth_users = array(
    'admin' => '$2y$10$/K.hjNr84lLNDt8fTXjoI.DBp6PpeyoJ.mGwrrLuCZfAwfSAGqhOW', //admin@123
    '游客' => password_hash('12345', PASSWORD_DEFAULT)
);
...
//在视图页面启用 highlight.js (https://highlightjs.org/)
...
//在视图页面启用 ace.js (https://ace.c9.io/)
$edit_files = true;

//date() 和 time() 的默认时区
//文档 -http://php.net/manual/en/timezones.php
$default_timezone = 'Asia/Shanghai'; // Asia/Shanghai

//文件管理器的根路径
//使用目录的绝对路径即：'/var/www/folder' 或 $_SERVER['DOCUMENT_ROOT'].'/folder'
$root_path = $_SERVER['DOCUMENT_ROOT'].'/epg';

//文件管理器中链接的根 url。相对于 $http_host。变体：''，'路径/到/子文件夹'
//如果 $root_path 位于服务器文档根目录之外，则将不起作用
$root_url = '';

//服务器主机名。如果错误可以手动设置
//$_SERVER['HTTP_HOST'].'/文件夹'
...
//图标路径。这可以是 .PNG 图像的完整 URL，也可以是基于文档根目录的路径。
//完整路径，例如 http://example.com/favicon.png
//本地路径，例如 images/icons/favicon.png
$favicon_path = 'data:image/svg+xml;base64,';

//要从列表中排除的文件和文件夹
//例如array('myfile.html', '个人文件夹', '*.php', ...)
$exclude_items = array();

//在线办公文档查看器
//可用规则是 'google'、'microsoft' 或 false
//Google => 使用 Google Docs Viewer 查看文档
//Microsoft => 使用 Microsoft Web Apps Viewer 查看文档
//false => 禁用在线文档查看器
...
//最大文件上传大小
//在 php.ini 中增加以下值才能正常工作
//memory_limit, upload_max_filesize, post_max_size
$max_upload_size_bytes = 5000000000; // size 5,000,000,000 bytes (~5GB)

//用于上传的块大小
//例如。如果 nginx 报告问题 413 实体太大，则减少到 1MB
$upload_chunk_size_bytes = 2000000; // 块大小 2,000,000 字节 (~2MB)

//可能的规则是 'OFF'、'AND' 或 'OR'
//OFF => 不检查连接 IP，默认为 OFF
...
//可在 HTML 中使用的外部 CDN 资源（替换为 GDPR 合规性）
$external = array(
